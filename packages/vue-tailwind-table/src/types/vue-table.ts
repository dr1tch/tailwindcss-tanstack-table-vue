...
import { type MRT_AggregationFns } from "@/utils/aggregation-fns"
import { type MRT_FilterFns } from "@/utils/filter-fns"
import { type MRT_SortingFns } from "@/utils/sorting-fns"
...
type MutableRefObject<T> = Record<string, T | any>
...
export type MRT_PaginationProps = Partial<Record<string, any>> & {
...
> & {
  ...
  setCreatingRow: (value: boolean | MRT_Row<TData> | null) => unknown
  setColumnFilterFns: (value: MRT_ColumnFilterFnsState) => unknown
  setDensity: (value: MRT_DensityState) => unknown
  setDraggingColumn: (value: MRT_Column<TData> | null) => unknown
  setDraggingRow: (value: MRT_Row<TData> | null) => unknown
  setEditingCell: (value: MRT_Cell<TData> | null) => unknown
  setEditingRow: (value: MRT_Row<TData> | null) => unknown
  setGlobalFilterFn: (value: MRT_FilterOption) => unknown
  setHoveredColumn: (
    value: MRT_Column<TData> | { id: string } | null
  ) => unknown
  setHoveredRow: (value: MRT_Row<TData> | { id: string } | null) => unknown
  setIsFullScreen: (value: boolean) => unknown
  setShowAlertBanner: (value: boolean) => unknown
  setShowColumnFilters: (value: boolean) => unknown
  setShowGlobalFilter: (value: boolean) => unknown
  setShowToolbarDropZone: (value: boolean) => unknown
}
...
//   Cell?: (props: {
//     cell: MRT_Cell<TData>
//     renderedCellValue: number | string | VNode
//     column: MRT_Column<TData>
//     row: MRT_Row<TData>
...
> & {
  ...
  mantineTableBodyCellProps?:
    | (HTMLPropsRef<HTMLTableCellElement> & ColumnAlignment)
    | ((props: {
        cell: MRT_Cell<TData>
        column: MRT_Column<TData>
        row: MRT_Row<TData>
  ...
  mantineTableBodyProps?:
    | HTMLPropsRef<HTMLTableSectionElement>
    | ((props: {
        table: MRT_TableInstance<TData>
      }) => HTMLPropsRef<HTMLTableSectionElement>)
  mantineTableBodyRowProps?:
    | HTMLPropsRef<HTMLTableRowElement>
    | ((props: {
